...
class _TelaSuporteWidgetState extends State<TelaSuporteWidget> {
  ...
  @override
  void dispose() {
    _textEditingController.dispose(); // Limpe o TextEditingController ao descartar o widget
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final maxLines = (screenHeight * 0.02).toInt();
            ...
            Align(
              ...
              child: Padding(
                ...
                child: SizedBox(
                  width: 300,
                  child: Form(
                    key: _formKey, // Associe a chave do formulário
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder( // Adicione esta linha para definir a borda padrão
